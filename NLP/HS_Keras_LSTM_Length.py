...
def train(X, y, X_valid, y_valid):
    ...
    vectorize_layer = TextVectorization(max_tokens=max_features, standardize=None, ngrams=3,
                                        output_mode='tf-idf')
    ...
    pickle.dump({'config': vectorize_layer.get_config(), 'weights': vectorize_layer.get_weights()},
                open(model_path + "tv_layer_LSTM_Length.pkl", "wb"))
    ...
    print('Shape of training set', X_train_vectorized.shape)
    print('Shape of Validation set', X_valid_vectorized.shape)
    ...
    checkpoint_cb = keras.callbacks.ModelCheckpoint(model_path + "Keras_LSTM_Length.h5", save_best_only=True)
...
def test(X, y, model_name, vectorizer_name):
    ...
    try:
        ...
        try:
            ...
            standard_scaler_file = model_path + 'StandardScaler/' + 'StandardScaler-Keras_22-09-2021_15-54-36.pkl'
        ...
        X_test_features = np.concatenate((pd.DataFrame(X_test_scaled, columns=['length', 'length_original_tokens',
                                                                          'length_original_text', 'number_non_words']),
                                     pd.DataFrame(X_test_vectorized.numpy())), axis=1)
...
# print("==================================================================================================")
# print("Validation")
# test(X_val, y_val['final_label_int'], model_name='Keras_LSTM_Length', vectorizer_name='tv_layer_LSTM_Length')
#
#
...
# y_test = test(data_Test, data_Test['final_label_int'], model_name='Keras_LSTM_Length',
#               vectorizer_name='tv_layer_LSTM_Length')
